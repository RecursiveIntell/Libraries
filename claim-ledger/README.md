...
**Current crate metadata:** version `0.2.0`, license [MIT](#license), Rust 2021
...
All items below are public in `0.2.0`. The crate root re-exports the common
surface; the public modules (`budget`, `candidate`, `error`, `ids`, `ledger`,
