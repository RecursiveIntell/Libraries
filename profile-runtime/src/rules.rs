        ...
        Self {
            ...
            family_rules: vec![
                ObligationFamilyRuleV1 {
                    obligation_family: "egress.allowed_route_classes".into(),
                    ...
                    explanation: "provider route classes narrow by intersection".into(),
                },
                ObligationFamilyRuleV1 {
                    obligation_family: "disclosure.allowed_classes".into(),
                    fold_class: FoldClassV1::Intersection,
                    ...
                    admissible_exception_classes: Vec::new(),
                    downgrade_behavior: "blocked".into(),
                    explanation: "disclosure classes narrow by intersection".into(),
                },
                ObligationFamilyRuleV1 {
                    obligation_family: "effect.allowed_classes".into(),
                    fold_class: FoldClassV1::Intersection,
                    output_kind: CompiledObligationKindV1::Effect,
                    monotone_additions_expected: true,
                    block_on_unresolved_conflict: true,
                    admissible_exception_classes: Vec::new(),
                    downgrade_behavior: "blocked".into(),
                    explanation: "effect classes narrow by intersection".into(),
                },
                ObligationFamilyRuleV1 {
                    obligation_family: "budget.max_input_tokens".into(),
                    ...
                    explanation: "input token ceilings tighten to the smallest cap".into(),
                },
                ObligationFamilyRuleV1 {
                    obligation_family: "budget.max_output_tokens".into(),
                    fold_class: FoldClassV1::MinOfMaxima,
                    output_kind: CompiledObligationKindV1::Effect,
                    monotone_additions_expected: true,
                    block_on_unresolved_conflict: true,
                    admissible_exception_classes: Vec::new(),
                    downgrade_behavior: "tighten".into(),
                    explanation: "output token ceilings tighten to the smallest cap".into(),
                },
                ObligationFamilyRuleV1 {
                    obligation_family: "budget.max_attempts".into(),
                    fold_class: FoldClassV1::MinOfMaxima,
                    output_kind: CompiledObligationKindV1::Effect,
                    monotone_additions_expected: true,
                    block_on_unresolved_conflict: true,
                    admissible_exception_classes: Vec::new(),
                    downgrade_behavior: "tighten".into(),
                    explanation: "attempt ceilings tighten to the smallest cap".into(),
                },
                ObligationFamilyRuleV1 {
                    obligation_family: "budget.max_concurrency".into(),
                    fold_class: FoldClassV1::MinOfMaxima,
                    output_kind: CompiledObligationKindV1::Effect,
                    monotone_additions_expected: true,
                    block_on_unresolved_conflict: true,
                    admissible_exception_classes: Vec::new(),
                    downgrade_behavior: "tighten".into(),
                    explanation: "concurrency ceilings tighten to the smallest cap".into(),
                },
                ObligationFamilyRuleV1 {
                    obligation_family: "budget.max_wall_time_ms".into(),
                    fold_class: FoldClassV1::MinOfMaxima,
                    output_kind: CompiledObligationKindV1::Effect,
                    monotone_additions_expected: true,
                    block_on_unresolved_conflict: true,
                    admissible_exception_classes: Vec::new(),
                    downgrade_behavior: "tighten".into(),
                    explanation: "wall-time ceilings tighten to the smallest cap".into(),
                },
                ObligationFamilyRuleV1 {
                    obligation_family: "budget.max_artifact_bytes".into(),
                    fold_class: FoldClassV1::MinOfMaxima,
                    output_kind: CompiledObligationKindV1::Effect,
                    monotone_additions_expected: true,
                    block_on_unresolved_conflict: true,
                    admissible_exception_classes: Vec::new(),
                    downgrade_behavior: "tighten".into(),
                    explanation: "artifact byte ceilings tighten to the smallest cap".into(),
                },
                ObligationFamilyRuleV1 {
                    ...
                    block_on_unresolved_conflict: true,
                    admissible_exception_classes: Vec::new(),
                    downgrade_behavior: "earliest_expiry".into(),
                    explanation: "policy expiry resolves to the earliest admitted expiry".into(),
                },
                ObligationFamilyRuleV1 {
                ...
                ObligationFamilyRuleV1 {
                    obligation_family: "residency.allowed_storage_regions".into(),
                    fold_class: FoldClassV1::Intersection,
                    ...
                    explanation: "storage region allowances narrow by overlap".into(),
                },
                ObligationFamilyRuleV1 {
                ...
                ObligationFamilyRuleV1 {
                    obligation_family: "residency.allowed_replay_regions".into(),
                    fold_class: FoldClassV1::Intersection,
                    output_kind: CompiledObligationKindV1::Replay,
                    monotone_additions_expected: true,
                    block_on_unresolved_conflict: true,
                    admissible_exception_classes: vec!["locality_exception".into()],
                    downgrade_behavior: "blocked_without_exception".into(),
                    explanation: "replay region allowances narrow by overlap".into(),
                },
                ObligationFamilyRuleV1 {
