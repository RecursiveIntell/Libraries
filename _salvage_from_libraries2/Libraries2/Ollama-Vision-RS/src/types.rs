...
pub struct TagOptions {
    ...
    /// Maximum number of tags to return. Tags beyond this limit are dropped.
    /// Default: 30.
    pub max_tags: usize,
    /// Maximum length of a single tag in characters. Tags longer than this
    /// are truncated. Default: 50.
...
pub struct CaptionOptions {
    ...
    pub prompt: Option<String>,
    /// Maximum caption length in characters. Captions beyond this are truncated
    /// at the last word boundary. Default: 500.
