...
run p20_static_scan python3 scripts/p20_scan_aidens.py --root . --out target/aidens-p20-2-audit/p20-scan --require-phase-reports-through 0 --fail-on-blocking
...
run scanner_selftest python3 scripts/p20_2_scanner_selftest.py
