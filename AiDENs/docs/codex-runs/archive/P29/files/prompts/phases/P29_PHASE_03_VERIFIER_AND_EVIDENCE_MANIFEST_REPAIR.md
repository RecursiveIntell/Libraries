# P29 Phase 03 — Verifier and evidence manifest repair

## Objective

Verifier and evidence manifest repair.
...
4. Update or create `handoffs/p29/PHASE_03_REPORT.md`.
...
Stop after this phase and use the matching injection from `P29_MANUAL_PHASE_INJECTIONS.md`. Write `handoffs/p29/PHASE_03_MANUAL_GATE.md`.
