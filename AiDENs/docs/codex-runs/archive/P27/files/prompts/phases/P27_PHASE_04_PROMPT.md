# P27 Phase 04 Prompt — Ownership scanner fail-closed behavior

## Scope

Execute only Phase 04: **Ownership scanner fail-closed behavior**.
...
- Emit `handoffs/p27/PHASE_04_REPORT.md`.
...
See `P27_PHASE_PLAN.md` Phase 04. Do not exceed that scope unless required to unblock this phase's acceptance gate.
