# P27 Phase 13 Prompt — Contract/schema conformance and duplicate-key hardening

## Scope

Execute only Phase 13: **Contract/schema conformance and duplicate-key hardening**.
...
- Emit `handoffs/p27/PHASE_13_REPORT.md`.
...
See `P27_PHASE_PLAN.md` Phase 13. Do not exceed that scope unless required to unblock this phase's acceptance gate.
