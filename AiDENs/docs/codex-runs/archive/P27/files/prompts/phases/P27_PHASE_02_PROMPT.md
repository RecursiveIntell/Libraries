# P27 Phase 02 Prompt — Active run truth surface normalization

## Scope

Execute only Phase 02: **Active run truth surface normalization**.
...
- Emit `handoffs/p27/PHASE_02_REPORT.md`.
...
See `P27_PHASE_PLAN.md` Phase 02. Do not exceed that scope unless required to unblock this phase's acceptance gate.
