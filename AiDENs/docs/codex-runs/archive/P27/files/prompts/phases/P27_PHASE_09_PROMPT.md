# P27 Phase 09 Prompt — Provider path E2E hardening

## Scope

Execute only Phase 09: **Provider path E2E hardening**.
...
- Emit `handoffs/p27/PHASE_09_REPORT.md`.
...
See `P27_PHASE_PLAN.md` Phase 09. Do not exceed that scope unless required to unblock this phase's acceptance gate.
