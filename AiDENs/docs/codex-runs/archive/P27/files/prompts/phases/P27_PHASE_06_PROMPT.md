# P27 Phase 06 Prompt — Scaffold profile crate claim cleanup

## Scope

Execute only Phase 06: **Scaffold profile crate claim cleanup**.
...
- Emit `handoffs/p27/PHASE_06_REPORT.md`.
...
See `P27_PHASE_PLAN.md` Phase 06. Do not exceed that scope unless required to unblock this phase's acceptance gate.
