# P27 Phase 00 Prompt — Intake, no-mutation audit, and scope lock

## Scope

Execute only Phase 00: **Intake, no-mutation audit, and scope lock**.
...
- Emit `handoffs/p27/PHASE_00_REPORT.md`.
...
See `P27_PHASE_PLAN.md` Phase 00. Do not exceed that scope unless required to unblock this phase's acceptance gate.
