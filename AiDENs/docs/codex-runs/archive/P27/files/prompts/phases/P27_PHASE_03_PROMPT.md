# P27 Phase 03 Prompt — Package self-replay and sibling-layout classification

## Scope

Execute only Phase 03: **Package self-replay and sibling-layout classification**.
...
- Emit `handoffs/p27/PHASE_03_REPORT.md`.
...
See `P27_PHASE_PLAN.md` Phase 03. Do not exceed that scope unless required to unblock this phase's acceptance gate.
