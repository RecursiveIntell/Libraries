# P27 Phase 20 Prompt — Final package and closeout

## Scope

Execute only Phase 20: **Final package and closeout**.
...
- Emit `handoffs/p27/PHASE_20_REPORT.md`.
...
See `P27_PHASE_PLAN.md` Phase 20. Do not exceed that scope unless required to unblock this phase's acceptance gate.
