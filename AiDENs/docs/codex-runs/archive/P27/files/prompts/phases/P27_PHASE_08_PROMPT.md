# P27 Phase 08 Prompt — Durable run receipt store v0

## Scope

Execute only Phase 08: **Durable run receipt store v0**.
...
- Emit `handoffs/p27/PHASE_08_REPORT.md`.
...
See `P27_PHASE_PLAN.md` Phase 08. Do not exceed that scope unless required to unblock this phase's acceptance gate.
