# P27 Phase 05 Prompt — Root Markdown truth and archive hygiene

## Scope

Execute only Phase 05: **Root Markdown truth and archive hygiene**.
...
- Emit `handoffs/p27/PHASE_05_REPORT.md`.
...
See `P27_PHASE_PLAN.md` Phase 05. Do not exceed that scope unless required to unblock this phase's acceptance gate.
