# P27 Phase 01 Prompt — Verifier and CI hard repair

## Scope

Execute only Phase 01: **Verifier and CI hard repair**.
...
- Emit `handoffs/p27/PHASE_01_REPORT.md`.
...
See `P27_PHASE_PLAN.md` Phase 01. Do not exceed that scope unless required to unblock this phase's acceptance gate.
