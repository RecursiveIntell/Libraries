# P27 Phase 15 Prompt — Megafile containment: CLI next

## Scope

Execute only Phase 15: **Megafile containment: CLI next**.
...
- Emit `handoffs/p27/PHASE_15_REPORT.md`.
...
See `P27_PHASE_PLAN.md` Phase 15. Do not exceed that scope unless required to unblock this phase's acceptance gate.
