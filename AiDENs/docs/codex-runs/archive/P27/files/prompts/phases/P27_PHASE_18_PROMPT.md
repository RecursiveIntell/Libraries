# P27 Phase 18 Prompt — Support profile and operator UX closure

## Scope

Execute only Phase 18: **Support profile and operator UX closure**.
...
- Emit `handoffs/p27/PHASE_18_REPORT.md`.
...
See `P27_PHASE_PLAN.md` Phase 18. Do not exceed that scope unless required to unblock this phase's acceptance gate.
