...
| `_vendor/Libraries2/job-queue` | durable jobs, leases, attempt lineage | host scheduler semantics |
| `_vendor/Libraries2/agent-graph` | graph/kernel adapters | collapsing all graphs into one |
