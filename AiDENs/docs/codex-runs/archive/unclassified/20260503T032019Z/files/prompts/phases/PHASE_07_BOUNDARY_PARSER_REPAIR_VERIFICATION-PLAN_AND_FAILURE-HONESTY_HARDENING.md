# P24 Phase 07 prompt — Boundary parser, repair, verification-plan, and failure-honesty hardening

Goal: Make parser/patch/repair boundaries strict and evidence-bearing. Risk-bearing outputs require verification plans or honest abstention/degradation.

Execute only this phase unless explicitly running the full P24 super-pass.

## Required outputs

- `AiDENs/handoffs/p24/PHASE_07_REPORT.md`
