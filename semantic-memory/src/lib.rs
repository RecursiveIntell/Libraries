...
pub use procedural_memory::{
    load_procedure_lifecycle_receipt, validate_procedure_artifact_v1,
    ...
    ProcedureEvidenceTestEnvelopeV1, ProcedureFixtureReceiptV1, ProcedureFixtureV1,
    ProcedureLifecycleDispositionV1, ProcedureLifecyclePermitV1, ProcedureLifecycleReceiptV1,
    ProcedurePreconditionV1, ProcedureRetrievalRequestV1, ProcedureRevocationV1, ProcedureRiskV1,
    ProcedureStepV1, ProcedureTestReceiptV1, ProcedureValidationV1, PROCEDURAL_MEMORY_ARTIFACT_V1,
...
pub use procedure_replay::{
    ...
    load_retained_replay_inputs, procedure_replay_permit_ref, record_replay_result,
    ProcedureOwnerSnapshotV1, ProcedureReplayAdmissionV1, ProcedureReplayComparisonV1,
    ProcedureReplayInputsV1, ProcedureReplayObservedIdentityV1, ProcedureReplayOutcomeV1,
    ProcedureReplayResultV1, ProcedureReplaySnapshotV1,
};
