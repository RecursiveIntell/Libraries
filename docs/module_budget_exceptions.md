...
| `forge-pilot/src/main_support/mod.rs` | 1600 | CLI argument parsing and command dispatch — single entry point |
| `forge-pilot/src/loop_runner.rs` | 1050 | OODA loop orchestration — linear flow with rich control structures |
| `knowledge-runtime/src/runtime/core.rs` | 1250 | Query pipeline — classification, planning, execution, merge |
