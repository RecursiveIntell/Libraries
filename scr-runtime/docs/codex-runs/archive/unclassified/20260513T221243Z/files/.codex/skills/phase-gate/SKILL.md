---
name: phase-gate
description: Enforce automated phase boundary checks and prevent phase drift during ClaimLedger completion.
---

Use this skill at every phase transition.

Phase gates are automatic. They are loaded from `.codex/auto_injections/`, not pasted manually.
