...
description: Maintain and audit ClaimLedger Codex control files, including prompts, auto-injections, hooks, rules, skills, and phase runner receipts.
---
...
3. Keep injections automatic under `.codex/auto_injections/`.
