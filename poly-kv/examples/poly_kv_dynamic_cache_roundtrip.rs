//! `poly_kv_dynamic_cache_roundtrip` — the HuggingFace integration
//! validation tool.
//!
...
//! measure PPL delta between baseline and poly-kv-compressed KV caches.
//!
//! Usage:
//!   poly_kv_dynamic_cache_roundtrip <input.json> <output_dir>
//!
//! Input JSON shape (see `scripts/build_poly_kv_corpus.py` for the
//! Python builder):
//!   {
//!     "shape": {
