...
- Rust compressed attention selection now uses partition-then-sort-selected top-k (`select_nth_unstable_by`) for cold-pool and pool+shell scoring paths instead of sorting every scored candidate.
