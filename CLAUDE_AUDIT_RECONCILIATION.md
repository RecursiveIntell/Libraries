...
The benchmark's self-assessment limitation was identified and corrected in FIX-003. FIX-008 now adds one execution-verified `temporal_correctness` case while the rest of the suite remains explicitly labeled fixture-asserted.
